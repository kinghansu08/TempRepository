...
addJavascript('/js/cookie.js'); // 쿠키 함수
 ...
 const check_input = () => { const check_xss = (input) => {
   ...
   return sanitizedInput;
    ...
    const passwordInput = document.getElementById('typePasswordX');   //getElementById=식별자를 가져옴 
    ...
    /*session_set(); // 세션 생성 *****
    loginForm.submit();*/   //loginForm 자바 스크립트 서브밋
    };
        ...
        if (sessionStorage) {
         ...
         function session_get() { //세션 읽기
            if (sessionStorage) {
             ...
             function init_logined(){//패스워드는 지우기
                if(sessionStorage){
                decrypt_text(); // 복호화 함수
               }
                else{
