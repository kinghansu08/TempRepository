            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="https://www.leagueoflegends.com/ko-kr/">게임 다운로드</a></li>
                        <li><a class="dropdown-item" href="#">롤 커뮤니티</a></li>
                        <li><a class="dropdown-item" href="#">깃허브페이지</a></li>
                    </ul>
                </li>
            </ul>
            <form class="d-flex ms-auto" role="search" onsubmit="return googleSearch()">
                ...
                <a href="login/join.html" class="btn btn-outline-success" id="login_btn">회원 가입</a>
            </form>
        </div>
    </div>
</nav>
...
<div style="display: flex; justify-content: center;">
    <a href="https://lol.inven.co.kr/" target="_blank">
    ...
    <table class="table table-dark table-bordered table-striped">
        ...
        <tbody>
            ...
            <tr class="table-primary">
              ...
              <td>루시안</td>
              <td>루시안2</td>
              <td colspan="2"><img src="IMAGE/바이1.png" width="100" height="50"> <font size="13">바이,바이2</font></td>
            </tr>
        </tbody>
    </table>
</div>
